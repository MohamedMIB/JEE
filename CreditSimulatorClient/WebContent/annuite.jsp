                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown submenu">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li class="nav-item active"><a class="nav-link" href="annuite.jsp">Calcule annuité</a></li>
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_inner_text">
                    <h2>Service</h2>
                    <p>Calcul de l'annuité de rembourcement</p>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
                    ...
                    <div class="col-lg-7">
                            <div class="single_blog_inner">   
                                    <div class="blog_comment_form">
                                        ...
                                        <form class="row contact_us_form" action="annuite" method="post" id="authForm" novalidate="novalidate">
                                            <div class="form-group col-sm-4">
                                           	    <label for="capital">Capital</label>
                                                <input type="text" class="form-control" id="capital" name="capital" placeholder="Le montant de l’emprunt (Capital)">
                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="duree">Duée en mois</label>
                     ...
                     <% if(session.getAttribute("resultA")!=null){ %>
                    <!-- if there is a return this block is shown -->
                    <div class="col-lg-5" style="overflow-x: scroll;">
                        <div class="blog_right_sidebar">
                            <aside class="r_widget quote_widget">
                                <div class="r_w_title">
                                    <h3>Votre résultat (l'annuité) est:</h3>
                                </div>
                                <div class="l_title">
                                    <h2 style="background-color: bisque;"><%=session.getAttribute("resultA") %> <span>MAD</span> </h2>
