                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown submenu">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="duree.jsp">Calcule durée</a></li>
                            </ul>
                        </li>
                        <% 
        ...
        <section class="blog_main_area p_100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                            <div class="single_blog_inner">   
                                    <div class="blog_comment_form">
                                        ...
                                        <form class="row contact_us_form" action="duree" method="post" id="authForm" novalidate="novalidate">
                    ...
                    <%if(session.getAttribute("resultR")!=null){ %>
                    ...
                    <div class="col-lg-5" style="overflow-x: scroll;">
                        <div class="blog_right_sidebar">
                            <aside class="r_widget quote_widget">
                                <div class="r_w_title">
                                    <h3>Votre résultat (Le durée en mois) est:</h3>
                                </div>
                                <div class="l_title">
                                    <h2 style="background-color: bisque;"><%=session.getAttribute("resultR") %> <span> mois</span> </h2>
               		...
               		<!-- end of result block -->
               		<%session.removeAttribute("resultR"); }%>
                </div>
            </div>
        </section>
        <!--================End Blog Main Area =================-->
